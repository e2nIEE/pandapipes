...
project = 'pandapipes'
copyright = '2020-2021 by Fraunhofer Institute for Energy Economics and Energy System Technology (IEE), Kassel. '
...
texinfo_documents = [
  ('index', 'jsonpy', u'jsonpy Documentation',
   ['Fraunhofer IEE', 'Kassel University'], 'jsonpy', 'One line description of project.',
   'Miscellaneous'),
]
