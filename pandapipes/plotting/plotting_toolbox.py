...
def get_collection_sizes_pps(net, bus_size=1.0, ext_grid_size=1.0, load_size=1.0, sgen_size=1.0,trafo_size=1.0
                         ):
    """
    Calculates the size for most collection types according to the distance between min and max
    geocoord so that the collections fit the plot nicely
    ...
    sizes = {
        ...
        "trafo": trafo_size*mean_distance_between_bus*2,
