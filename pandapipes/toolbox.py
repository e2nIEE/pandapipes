...
from pandapipes.idx_branch import TABLE_IDX as TABLE_IDX_BRANCH, ELEMENT_IDX as ELEMENT_IDX_BRANCH, \
    ...
    T_OUT as T_OUT_BRANCH, JAC_DERIV_DT_NODE_N, JAC_DERIV_DT_NODE_B, \
    LOAD_VEC_NODES_T, VINIT_T as VINIT_T_BRANCH, \
...
branch_pit_indices = {
    ...
    T_OUT_BRANCH: "T_OUT",
    JAC_DERIV_DT_NODE_B: "JAC_DERIV_DT_NODE_B",
    JAC_DERIV_DT_NODE_N: "JAC_DERIV_DT_NODE_N",
    LOAD_VEC_NODES_T: "LOAD_VEC_NODES_T",
