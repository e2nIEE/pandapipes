...
def test_pressure_control_from_measurement_parameters(use_numba):
    ...
    pandapipes.create_pipe_from_parameters(net, j2, j3, length_km=5., diameter_mm=0.1022 * 1000, k_mm=1.)
    pandapipes.create_pipe_from_parameters(net, j3, j4, length_km=10., diameter_mm=0.1022 * 1000, k_mm=1.)
