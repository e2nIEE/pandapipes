...
def test_circulation_pump_constant_mass(use_numba):
    """
        :return:
        :rtype:
        """
    ...
    pandapipes.create_pipe_from_parameters(net, j1, j2, length_km=0.43380, diameter_mm=0.1022 * 1000, k_mm=1.)
    pandapipes.create_pipe_from_parameters(net, j3, j4, length_km=0.26370, diameter_mm=0.1022 * 1000, k_mm=1.)
