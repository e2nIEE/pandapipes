...
def test_mass_storage(use_numba):
    ...
    pandapipes.create_pipe_from_parameters(net, j1, j2, length_km=1, diameter_mm=0.5 * 1000)
    pandapipes.create_pipe_from_parameters(net, j2, j3, length_km=1, diameter_mm=0.5 * 1000)
