...
def release_control_test_network_water():
    # empty net
    ...
    # pipes
    pp.create_pipe_from_parameters(net, from_junction=0, to_junction=8, length_km=3, diameter_mm=0.01 * 1000, k_mm=1,
                                   loss_coefficient=0, sections=10, u_w_per_m2k=10, text_k=293, qext_w=0.,
                                   name="Pipe 0", index=None, geodata=None, in_service=True, type="pipe")
    pp.create_pipe_from_parameters(net, 9, 2, length_km=6, diameter_mm=0.075 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=3, name="Pipe 1")
    pp.create_pipe_from_parameters(net, 2, 12, length_km=5, diameter_mm=0.06 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=20, name="Pipe 2")
    pp.create_pipe_from_parameters(net, 4, 12, length_km=0.1, diameter_mm=0.07 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=2, name="Pipe 3")
    pp.create_pipe_from_parameters(net, 5, 3, length_km=1, diameter_mm=0.09 * 1000, k_mm=.1, sections=10, u_w_per_m2k=3,
                                   name="Pipe 4")
    pp.create_pipe_from_parameters(net, 4, 11, length_km=2.5, diameter_mm=0.08 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=15, name="Pipe 5")
    pp.create_pipe_from_parameters(net, 7, 13, length_km=4.5, diameter_mm=0.085 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=2.5, name="Pipe 6")
    pp.create_pipe_from_parameters(net, 1, 7, length_km=4, diameter_mm=0.03 * 1000, k_mm=.1, sections=10, u_w_per_m2k=1,
                                   name="Pipe 7")
...
def release_control_test_network_gas():
    # empty net
    net = pp.create_empty_network("net", add_stdtypes=False)
    ...
    # pipes
    pp.create_pipe_from_parameters(net, from_junction=0, to_junction=1, length_km=3, diameter_mm=0.1 * 1000, k_mm=1,
                                   loss_coefficient=0, sections=10, u_w_per_m2k=10, text_k=293, qext_w=0.,
                                   name="Pipe 0", index=None, geodata=None, in_service=True, type="pipe")
    pp.create_pipe_from_parameters(net, 2, 3, length_km=6, diameter_mm=0.075 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=3, name="Pipe 1")
    pp.create_pipe_from_parameters(net, 3, 4, length_km=5, diameter_mm=0.06 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=20, name="Pipe 2")
    pp.create_pipe_from_parameters(net, 4, 5, length_km=0.1, diameter_mm=0.07 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=2, name="Pipe 3")
    pp.create_pipe_from_parameters(net, 5, 6, length_km=4.5, diameter_mm=0.085 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=2.5, name="Pipe 4")
    pp.create_pipe_from_parameters(net, 8, 7, length_km=4, diameter_mm=0.03 * 1000, k_mm=.1, sections=10, u_w_per_m2k=1,
                                   name="Pipe 5")

    pp.create_pipe_from_parameters(net, 9, 10, length_km=1, diameter_mm=0.03 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=1, name="Pipe 6")
    pp.create_pipe_from_parameters(net, 11, 12, length_km=1.5, diameter_mm=0.09 * 1000, k_mm=.1, sections=10,
                                   u_w_per_m2k=3, name="Pipe 7")
...
if __name__ == '__main__':
    water_net = release_control_test_network_water()
    gas_net = release_control_test_network_gas()
