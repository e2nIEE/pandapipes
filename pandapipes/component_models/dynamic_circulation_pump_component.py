...
class DynamicCirculationPump(CirculationPump):
    ...
    def adaption_before_derivatives_hydraulic(cls, net, branch_pit, node_pit, idx_lookups, options):
        ...
        hl = np.array(list(map(lambda x, y, z: x.get_m_head(y, z), fcts, vol_m3_s, actual_pos))) # m head
        pl = np.divide((rho * GRAVITATION_CONSTANT * hl), P_CONVERSION)[0] # bar
        ...
        t_flow_k = circ_pump_tbl.t_flow_k.values
    ...
    def extract_results(cls, net, options, branch_results, nodes_connected, branches_connected):
        ...
        #res_table["p_lift_bar"].values[in_service] = deltap_bar[in_service]