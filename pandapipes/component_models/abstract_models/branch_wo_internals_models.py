...
from pandapipes.idx_branch import FROM_NODE, TO_NODE, T_OUT, ELEMENT_IDX, RHO, ETA, CP, ACTIVE
...
class BranchWOInternalsComponent(BranchComponent):
    ...
    def create_pit_branch_entries(cls, net, branch_pit):
        ...
        branch_wo_internals_pit[:, T_OUT] = node_pit[to_nodes, TINIT_NODE]
        tm = (node_pit[from_nodes, TINIT_NODE] + branch_wo_internals_pit[:, T_OUT]) / 2
        fluid = get_fluid(net)
