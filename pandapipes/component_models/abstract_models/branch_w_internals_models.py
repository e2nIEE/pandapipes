...
from pandapipes.idx_branch import ACTIVE, FROM_NODE, TO_NODE, RHO, ETA, CP, ELEMENT_IDX, T_OUT
...
class BranchWInternalsComponent(BranchComponent):
    ...
    def create_pit_branch_entries(cls, net, branch_pit):
        ...
        branch_w_internals_pit[:, T_OUT] = node_pit[to_nodes, TINIT_NODE]
        tm = (node_pit[from_nodes, TINIT_NODE] + branch_w_internals_pit[:, T_OUT]) / 2
        fluid = get_fluid(net)
