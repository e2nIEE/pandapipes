...
from pandapipes.idx_branch import D, AREA, JAC_DERIV_DP, JAC_DERIV_DP1, JAC_DERIV_DV, VINIT, LOAD_VEC_BRANCHES
...
class FlowControlComponent(BranchWZeroLengthComponent):
    ...
    def create_pit_branch_entries(cls, net, branch_pit):
        ...
        rho_n = fluid.get_density([NORMAL_TEMPERATURE] * len(fc_branch_pit))
        fc_branch_pit[:, VINIT] = net[cls.table_name()].controlled_mdot_kg_per_s.values / \
                                  (fc_branch_pit[:, AREA] * rho_n)
