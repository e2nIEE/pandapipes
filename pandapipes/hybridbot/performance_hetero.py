...
from pandapipes.networks.simple_gas_networks import gas_3parallel, gas_meshed_delta, schutterwald, gas_strand_2pipes, gas_tcross1
...
simple_plot(net)
#
# net_gas_strand_2pipes = gas_strand_2pipes()
#
# simple_plot(net_gas_strand_2pipes)
#
# net_gas_tcross1 = gas_tcross1()
#
# simple_plot(net_gas_tcross1)
