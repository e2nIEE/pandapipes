...
def water_district_grid(method="nikuradse"):
    """Load a STANET district test network, converted to a pandapipes network.
...
def water_combined_mixed(method="colebrook"):
    """Load an OpenModelica water network with a mixed set of components, converted to a pandapipes network.
...
def water_combined_versatility(results_from="openmodelica", method="colebrook"):
    """Load a versatility test network from STANET or OpenModelica, converted to a pandapipes network.
...
def water_meshed_delta(results_from="openmodelica", method="colebrook"):
    """Load a meshed, delta-shaped water test network, converted to a pandapipes network.
...
def water_meshed_pumps(results_from="openmodelica", method="colebrook"):
    """Load a meshed water test network with pumps, converted to a pandapipes network.
...
def water_meshed_heights(method="colebrook"):
    """Load a meshed OpenModelica water test network with varying heights, converted to a pandapipes network.
...
def water_meshed_2valves(results_from="openmodelica", method="colebrook"):
    """Load a meshed water test network with two valves, converted to a pandapipes network.
...
def water_one_pipe1(results_from="openmodelica", method="colebrook"):
    """Load a water test network with one pipe (variant 1), converted to a pandapipes network.
...
def water_one_pipe2(results_from="openmodelica", method="colebrook"):
    """Load a water test network with one pipe (variant 2), converted to a pandapipes network.
...
def water_one_pipe3(results_from="openmodelica", method="colebrook"):
    """Load a water test network with one pipe (variant 3), converted to a pandapipes network.
...
def water_simple_strand_net( results_from="openmodelica", method="colebrook"):
    """Load a simple, strand-shaped water test network, converted to a pandapipes network.
...
def water_strand_2pipes(results_from="openmodelica", method="colebrook"):
    """Load a strand-shaped water test network with two pipes, converted to a pandapipes network.
...
def water_strand_cross(results_from="openmodelica", method="colebrook"):
    """Load a strand-shaped water test network with a cross junction, converted to a pandapipes network.
...
def water_strand_net_2pumps(method="colebrook"):
    """Load a strand-shaped OpenModelica water test network with two pumps, converted to a pandapipes network.
...
def water_strand_pump():
    """Load a strand-shaped STANET water test network with a pump, converted to a pandapipes network.
...
def water_tcross(results_from="openmodelica", method="colebrook"):
    """Load a T-cross-shaped water test network, converted to a pandapipes network.
...
def water_tcross_valves(method="colebrook"):
    """Load a T-cross-shaped OpenModelica water test network with valves, converted to a pandapipes network.
...
def water_2eg_two_pipes(results_from="openmodelica", method="colebrook"):
    """Load a water test network with two pressure junctions and two pipes, converted to a pandapipes network.
