...
def test_valve_flow_contrl_heat_consumer():
    ...
    pandapipes.create_flow_control(net, j3, j2, 10, 0.1)
    pandapipes.create_heat_exchanger(net, j8, j3, 0.1, -5000)
    pandapipes.create_pipes_from_parameters(net, [j2, j7], [j4, j8], 0.1, 0.1)
    pandapipes.create_heat_consumer(net, j5, j6, 0.1, 10000, 10)
