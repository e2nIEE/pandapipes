...
def test_create_valves(create_empty_net):
    ...
    j1 = pandapipes.create_junction(net, 3, 273)
    j2 = pandapipes.create_junction(net, 3, 273)
    pandapipes.create_valves(net, [j1, j1], [j2, j2], 'j', 0.2)
    ...
    v = pandapipes.create_valves(
        net, [j1, j1], [j2, j2], et='j', diameter_m=0.8, opened=False, name="test", new_col=0.01,
    ...
    j2 = pandapipes.create_junction(net, 3, 273)
    v = pandapipes.create_valves(
        net, [j1, j1], [j2, j2], et='j', diameter_m=[0.8, 0.7], opened=[True, False], name=["v1", "v2"],
...
def test_create_valves_raise_except(create_empty_net):
    ...
    with pytest.raises(UserWarning, match=r"trying to attach to non existing junctions"):
        pandapipes.create_valves(net, [1, 3], [4, 5], et='j', diameter_m=0.8, opened=False, name="test",
                                 loss_coefficient=0.3)

    pandapipes.create_valves(net, [j1, j1], [j2, j3], et='j', diameter_m=0.8, opened=False, name="test",
                             loss_coefficient=0.3, index=[0, 1])
    with pytest.raises(UserWarning, match=r"with indexes \[0 1\] already exist"):
        pandapipes.create_valves(net, [j1, j1], [j2, j3], et='j',diameter_m=0.8, opened=False,
